...
public class NoteBookProgram {
	 ...
	 */
	private static File dotDir = new File(System.getProperty("user.home") + File.separator + "." + NoteBookProgram.getProgramname());
	...
	public static String generatedComment() {
		return "generated by " + NoteBookProgram.getProgramname() + " " + VersionName.version;
	}
